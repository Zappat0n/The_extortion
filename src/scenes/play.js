...
class playGame extends Phaser.Scene{
  ...
  create(){
      ...
      this.addPlatform(GAME_WIDTH, GAME_WIDTH / 2, GAME_HEIGHT * gameOptions.platformVerticalLimit[1]);
  ...
  addMountains(){
      ...
      if(rightmostMountain < GAME_WIDTH * 2){
          let mountain = this.physics.add.sprite(rightmostMountain + Phaser.Math.Between(100, 350), GAME_HEIGHT + Phaser.Math.Between(0, 100), "mountain");
  ...
  update(){
      ...
      this.platformGroup.getChildren().forEach(function(platform){
          let platformDistance = GAME_WIDTH - platform.x - platform.displayWidth / 2;
      ...
      if(minDistance > this.nextPlatformDistance){
          ...
          let minPlatformHeight = GAME_HEIGHT * gameOptions.platformVerticalLimit[0];
          let maxPlatformHeight = GAME_HEIGHT * gameOptions.platformVerticalLimit[1];
